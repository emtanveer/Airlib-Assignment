...
/**
 * [ApiService] is a Retrofit interface that defines the endpoints for accessing the API.
 *
 * This interface provides methods to fetch listings from the API.
 */
interface ApiService {
    @GET("73fbd17f-b3f9-4ba8-868f-1a582fd4519b") // WARNING: Replace with actual endpoint
